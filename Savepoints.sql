...
--DE LOS RESULTADOS QUE OBTENEMOS (SE PUEDE PROBAR EN PGADMIN EJECUTANDO COMANDO A COMANDO)
...
¡	SAVEPOINT my_savepoint1;	-- MARCO PRIMER SAVEPOINT
	...
	SELECT insert_forsavepoints (3) INTO result;
	-- SI HA RETORNADO UN 1 EJECUTAR EL COMANDO DE CREACION DE LOG Y MARCAR UN NUEVO SAVEPOINT
	savepointslogs VALUES (DEFAULT, 'INSERT 3 WITH SUCCESS', current_timestamp);
	SAVEPOINT my_savepoint2;	--SEGUNDO SAVEPOINT

	SELECT insert_forsavepoints (1) INTO result;  --CON EL CODIGO DE EJEMPLO INICIAL YA EXISTIRIA EL VALOR 1
	-- SI HA RETORNADO UN CERO EJECUTAR
	...
	SELECT insert_forsavepoints (4) INTO result;
	-- SI HA RETORNADO UN CERO EJECUTAR
	...
	SELECT insert_forsavepoints (5) INTO result;
	-- SI HA RETORNADO UN CERO EJECUTAR	
